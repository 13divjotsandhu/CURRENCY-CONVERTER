...
if (isNaN(amount) || amount <= 0) {
    // Display an error message or handle the case when there is no input
...
//fetches when user input currency
fromAmountElement.addEventListener('input',getExchangeRate);
//fetch rates when user change curreny
